...
const Navbar = () => {
  ...
  return(
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      ...
      <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gary-900 bg-[#262626] ease-out duration-500': 'fixed left-[-100%]' }>
      <h1 className='w-full text-3xl font-bold text-white m-4'><span className="text-[#65FBD2]">&lt;/</span>JASON C<span className="text-[#65FBD2]">&gt;</span></h1>
